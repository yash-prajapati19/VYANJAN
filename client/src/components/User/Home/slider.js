...
const Navbar = () => {
  ...
  return (
    <Fragment>
      ...
      <style>
        @import
        url('https://fonts.googleapis.com/css2?family=Rowdies&family=Ubuntu:wght@700&display=swap');
      </style>
      <div className="main-slider">
        <div className="slider">
          <div className="slider-area">
            <div className="slider-img show active" id="s1">
              <img src={Img1} alt="" />
              <div className="parda"></div>
              <p>
                PATHAN KI SITE SE <br></br> ORDER KAROGE
              </p>
              <p>TOH PATHAN AAYEGA HI..</p>
            </div>
            <div className="slider-img show" id="s2">
              <img src={Img2} alt="" />
              <div className="parda"></div>
            ...
            <div className="slider-img show" id="s3">
              <img src={Img4} alt="" />
              <div className="parda"></div>
              <p>CHAL CHAL</p>
              <p>PANI PURI</p>
            ...
            <div className="slider-img show" id="s4">
              <img src={Img3} alt="" />
              <div className="parda"></div>
              <p>JHUKEGA NHI...</p>
